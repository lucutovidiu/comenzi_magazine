...
const Receptie = (props) => {
    ...
    function handleSubmit(e) {
        ...
        let articoleSelectatePtGraph = articoleSelectate.map(item => ({
            nume_articol: item.nume_articol,
            cantitate: parseInt(item.cantitate) + parseInt(articole.filter(ar => ar.nume_articol === item.nume_articol)[0].cantitate_stoc)
        }))
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="jumbotron jumboSettings">
                                <h2 className="text-center jumboSettings fancyText">Introducere Noi Cantitati / Receptie</h2>
                                <br />
                                <br />
                                        ...
                                        <div className="offset-sm-1 col-sm-8">
                                            <div className="form-group row text-right">
                                                ...
                                                <div className="col-sm-4 text-left">
                                                    <span className="col-sm float-left neg-ml-1 col-form-label">Cantitate Intrare</span>
                                                </div>
                                            </div>
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-group row">
                                                    <button className="offset-sm-6 col-sm-3 btn btn-primary">+ Adauga Receptie</button>
                                                </div>
